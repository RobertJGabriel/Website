...
function canvas() {
    ...
    menuDiv.setAttribute('class', 'panel panel-default');
    menuDiv.setAttribute('style', 'padding:20px');
    ...
    newCanvas.setAttribute('class', 'panel panel-default');
    ...
    tipMain.innerHTML = "Hold Shift and drag the mouse to draw a cicrle";
